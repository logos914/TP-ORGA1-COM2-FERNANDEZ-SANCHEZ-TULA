...
CalcularPuntaje proc
    ...
    mov ah, offset[botes_Jug1+bx]
    mov al, offset[botes_Jug2+bx]
    ...
    FinalLoopito:
    inc bx
    loop loopitoQueRecorre
    
    
    
    mov ax,si
    call PuntajeACadena
    mov  PuntajeJugador1,ah
    mov  PuntajeJugador1[1],al
...
int 21h 
    ...
    mov ax,di
    call PuntajeACadena
    mov  PuntajeJugador2,ah
    mov  PuntajeJugador2[1],al
